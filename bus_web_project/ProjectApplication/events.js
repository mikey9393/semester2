...
$(document).ready(() => {
//toggle #menu_control 
    //$(".questions").hide(); // hidden default
    

    $("#menu_control a").mouseover(() => {
        $("div#shopping_cart").show(); 
        // Advanced Syntax for animate().
        // $("#menu_control a").animate(
        //   {fontSize: "650%",opacity: 1, left: "+=175", duration: 2000, specialEasing:{fontSize: "easeInExpo", left: "easeOutExpo"}, 
        //   complete: () => $("#menu_control a").fadeIn(1000).fadeOut(1000) })
